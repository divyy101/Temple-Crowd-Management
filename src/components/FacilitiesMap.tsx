...
const FacilitiesMap: React.FC<FacilitiesMapProps> = ({ selectedTemple, templeData, language = 'en' }) => {
  ...
  const templeCoordinates = {
    somnath: { lat: 20.8880, lng: 70.4011, name: '1. Somnath Jyotirlinga' },
    dwarka: { lat: 22.2394, lng: 68.9678, name: '2. Dwarkadhish Mandir' },
    ambaji: { lat: 24.2420, lng: 72.8347, name: '3. Ambaji Shakti Peeth' },
    pavagadh: { lat: 22.4669, lng: 73.5339, name: '4. Kalika Mata Mandir' }
  };
